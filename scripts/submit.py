...
MARKETING_URL = 'https://snarfnet.github.io/'
BUILD_NUMBER = sys.argv[1]
SCREENSHOT_DIR = os.path.join(os.path.dirname(__file__), '..', 'screenshots')
SCREENSHOT_DISPLAY_TYPE = 'APP_IPHONE_67'
VERSION_STRING = '1.0'
WHATS_NEW = 'Initial release of Cyber Soroban - a futuristic abacus with neon HUD visuals and electronic sound effects.'
